  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 pt-28 pb-16 max-w-6xl">
        <h1 className="text-4xl font-bold text-primary-solid mb-8">Terms & Privacy Policy</h1>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to PerfectPath.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to PerfectPath, accessible from <a href="http://www.perfectpath.xyz" rel="external nofollow noopener" target="_blank">http://www.perfectpath.xyz</a></p>
</li>
<li>
...
<ul>
<li>By email: contact@perfectpath.xyz</li>
</ul>
      </main>
